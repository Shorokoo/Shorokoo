...
/// <see cref="IShorokooInferenceBackend.CreateTensorInBackendMemory"/> and the uninitialized
...
public static class TensorElementLayout
{
    ...
    /// <see cref="IShorokooInferenceBackend.CreateStringTensor"/> is what builds one — or is not
