...
/// <summary>
/// Shape inference for ONNX <c>LpPool</c>. Output spatial dims follow the same
/// kernel/stride/padding arithmetic as <see cref="AveragePoolOp"/>; the channel and
/// batch dims pass through.
/// </summary>
internal sealed class LpPoolOp : QuickOp
{
    public override string OpCode => OpCodes.LP_POOL;
