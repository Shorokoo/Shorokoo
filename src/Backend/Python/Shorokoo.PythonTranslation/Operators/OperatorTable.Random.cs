...
// Random draws, and Dropout, which draws its mask; the semantics are in each support package's ops_random.py.
...
internal static partial class OperatorTable
{
    static partial void RegisterRandom(Registry table)
    {
        ...
        const GradientRule none = GradientRule.NotDifferentiable;
