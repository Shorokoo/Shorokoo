...
| resolved | 2⁻³⁹ up to 8, the 42 weight classes between | individual `float32` values, each with the mass of the interval it stands for — except at the top of the tail, where a float's cell falls under one position in worth — from 7.6008 up — and, from 7.601182 up, 577,209 of them get none | all the rest |
