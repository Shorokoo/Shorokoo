...
/// <summary>
/// Variadic elementwise <c>Max</c> with multidirectional broadcasting over all inputs.
/// Computes concrete float/int values when every input carries data.
/// </summary>
internal sealed class MaxOp : QuickOp
{
    public override string OpCode => OpCodes.MAX;
