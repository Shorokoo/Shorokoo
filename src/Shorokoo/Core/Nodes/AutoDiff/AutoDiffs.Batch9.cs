...
namespace Shorokoo.Core.Nodes.AutoDiff
{
    internal static partial class AutoDiffs
    {
        ...
        internal static IVariable?[] GruGradient(IVariable?[] inputs, IVariable?[] outputGrads, OnnxCSharpAttributes attributes)
        {
            ...
            IVariable? Wbz = null, Wbr = null, Wbh = null, Rbz = null, Rbr = null, Rbh = null;
            IVariable? bSq = null;
            if (b is not null)
            {
            ...
            IVariable? dBacc = b is not null ? OnnxOp.Sub(bSq!, bSq!) : null;  // [6H] zeros or null
