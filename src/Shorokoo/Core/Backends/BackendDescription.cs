...
public enum ComputeDevice
{
    ...
    /// off as the CPU, so that <see cref="DefaultBackend.RequireDevice"/> refuses it.
    /// </summary>
    Other,
}
...
/// enforces.
///
/// <para>Read it off the live backend with <see cref="DefaultBackend.Describe"/>, or off the
