...
namespace Shorokoo
{
    ...
    /// <see cref="TrainingRig.FromScratch(Shorokoo.Graph.FastComputationGraph, Shorokoo.Graph.FastComputationGraph, Shorokoo.Graph.FastComputationGraph, NamedModelParam[], IOptimizerHyperparameters, Shorokoo.RngConfig?)"/>.
    /// </summary>
