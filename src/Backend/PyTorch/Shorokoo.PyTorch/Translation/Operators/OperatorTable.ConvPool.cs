...
// Convolution and pooling; the semantics are in shorokoo_torch/ops_conv_pool.py.
internal static partial class OperatorTable
{
    static partial void RegisterConvPool(Registry table)
    {
        ...
        table.Map("ConvInteger", M + "conv_integer", convolution, gradient: TorchGradient.NotDifferentiable);
