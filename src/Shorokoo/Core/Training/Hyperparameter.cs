...
namespace Shorokoo
{
    ...
    /// <see cref="TrainingRig.FromScratch(Shorokoo.Graph.ComputationGraph, Shorokoo.Graph.ComputationGraph, Shorokoo.Graph.ComputationGraph, NamedModelParam[], IOptimizerHyperparameters, Shorokoo.RngConfig?, Shorokoo.Runtime.ComputeContext?, Shorokoo.Runtime.ComputeContext?, System.IProgress{Shorokoo.Graph.BuildProgress}, Shorokoo.TrainingBackend?)"/>.
    /// </summary>
