...
namespace Shorokoo
{
    ...
    public enum CheckpointComponents
    {
        ...
        /// rebuild the rig from the file with the static <see cref="TrainingRig.Load(string, Runtime.ComputeContext?, Runtime.ComputeContext?, IProgress{Graph.BuildProgress}, TrainingBackend?)"/>.
    ...
    public class TrainingCheckpoint
    {
        ...
        /// constituents — the static <see cref="TrainingRig.Load(string, Runtime.ComputeContext?, Runtime.ComputeContext?, IProgress{Graph.BuildProgress}, TrainingBackend?)"/>
