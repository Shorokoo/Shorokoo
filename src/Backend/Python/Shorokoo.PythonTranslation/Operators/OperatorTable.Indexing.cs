...
// Indexing into a tensor; the semantics are in each support package's ops_indexing.py.
internal static partial class OperatorTable
{
    static partial void RegisterIndexing(Registry table)
    {
        ...
        table.Map("NonZero", M + "non_zero", gradient: GradientRule.NotDifferentiable);
    }
}
