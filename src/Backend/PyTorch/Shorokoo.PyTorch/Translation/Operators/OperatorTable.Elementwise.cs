...
// Elementwise math and activations; the semantics are in shorokoo_torch/ops_elementwise.py.
internal static partial class OperatorTable
{
    static partial void RegisterElementwise(Registry table)
    {
        ...
        table.Map("Hardmax", M + "hardmax", ["axis"], opset: true, gradient: TorchGradient.NotDifferentiable);
