...
/// <summary>
/// The Shorokoo backend for Windows x64 on the CPU. It creates ONNX Runtime
/// sessions on ORT's default (CPU) execution provider — the CPU EP needs no
/// configuration, so this backend adds none. It ships in the <c>Shorokoo.WinCPU</c>
...
/// <code>
/// DefaultBackend.Instance = new WinCpuBackend();
/// </code>
...
/// <code>
/// var context = new ComputeContext(new WinCpuBackend());
/// </code>
...
/// <c>Shorokoo.WinCPU.WinCpuBackend</c>.</para>
/// </summary>
public sealed class WinCpuBackend : OrtBackend
{
    /// <summary>
