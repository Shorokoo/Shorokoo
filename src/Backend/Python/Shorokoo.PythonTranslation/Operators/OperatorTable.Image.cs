...
// Image and geometry, and the block rearrangements; the semantics are in each support package's ops_image.py.
internal static partial class OperatorTable
{
    static partial void RegisterImage(Registry table)
    {
        ...
        table.Map("ImageDecoder", M + "image_decoder", ["pixel_format"], gradient: GradientRule.NotDifferentiable);
    }
}
