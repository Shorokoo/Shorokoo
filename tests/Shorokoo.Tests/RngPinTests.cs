...
public class RngPinTests
{
    ...
    public void TestPinSkeletonGroupsLoopScopesForFeedsAndInLoopParamsAlike()
    {
        ...
        Assert.Contains("// in the scope at ModelId path [1, -1] — a loop body, a module reached from one, or a model a ModelSequence position picks at run time:", feedSkeleton);
